                ...
                <div className="card horizontal-flexbox">
                    <div className="card-text vertical-flexbox">
                        ...
                        <div className="cta horizontal-flexbox">
                            ...
                            <Link to={`shop/:${props.sotd.sotdName}`} onClick={() => localStorage.setItem('selectedShoe', props.sotd.sotdAllData)} ><button className="avg-button pointer">Check This Out</button></Link>
                        </div>
                    </div>
