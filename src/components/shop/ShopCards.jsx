...
export default function ShopCards(props) {
    return(
        <Link to={`./:${props.shoe.shoeName}`} onClick={() => localStorage.setItem('selectedShoe', JSON.stringify(props.shoe))} className={` link vertical-flexbox pointer avg-button ${styles.card}`}>
