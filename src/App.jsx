    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/shop" element={<Shop nike={props.nike}setApiError={props.setApiError} setLoading={props.setLoading} searchResults={props.searchResults} setSearchResults={props.setSearchResults} setSearchThis={props.setSearchThis} mostPopular={props.mostPopular} setSelectedShoe={props.setSelectedShoe} />} />
